        ...
        <FooterSectionStyled className='u-pad-lg-2' theme={theme}>
            <nav className="bottom-navigation">
                <ul className="logo-con">
                    ...
                    <p>
                    Visit our blog to stay up-to-date with the latest news, trends, 
                    and insights in the digital marketing and technology space.
            ...
            <div className="footer-copywrite">
                <p>
                    Copyright © 2023 <span> Universal </span>. All rights reserved.
                </p>
            </div>
        </FooterSectionStyled>
    )
