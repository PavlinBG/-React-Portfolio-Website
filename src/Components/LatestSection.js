        ...
        <LatestSectionStyled className='u-pad-lg-2' theme={theme}>
            <div className="title-con">
                <Title
                    ...
                    subtext="At our agency, we are proud to showcase our latest digital work, which includes: "
                />
            </div>
            ...
            <div className="latest-container">
                <div className="latest-content">
                    ...
                    <div className="latest-text">
                        ...
                        <p>
                        We recently developed a custom Android app for a client in the healthcare industry. The app is designed to help patients manage their medications and appointments, and features a user-friendly interface and intuitive functionality.
